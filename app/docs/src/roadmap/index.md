...
## System Initiative MCP Server (Generally Available)
...
## Better data connectivity (Generally Available)
...
Think of this as templates, import, and workflows combined. Essentially,
...
work will allow users to have basic sorting and filtering of events.
...
workspace, pass data to a component, trigger a management function, and check
