...
Start by finding the `create` API for the schema you wish to model. For example,
if you were modeling the AWS EC2 Key Pair, the command would be
...
The resulting schema definition will correspond to the CLI skeleton of the AWS
CLI:
