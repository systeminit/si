...
This is a huge boon, in particular when you are writing more complex automation using our [public API](./public-api.md). We use this feature to do things like trigger increases in tracing for applications during troubleshooting, etc. The sky's the limit.
