<template>
  ...
  >
    <div class="flex flex-col">
      <ErrorMessage
        v-if="
          selectedFuncSummary.kind === 'Action' //editingFunc?.associations?.type === 'action'
        "
        icon="alert-triangle"
        tone="warning"
        variant="block"
      ...
      >
        ...
        {{
          selectedFuncSummary.kind === "Attribute" ? "attributes" : "assets"
        }}.
      </ErrorMessage>
      ...
      >
        <IconButton
          ...
          :requestStatus="execFuncReqStatus"
          :disabled="!(selectedFuncSummary.kind !== 'Authentication')"
          @click="execFunc"
        />
        <IconButton
          tooltip="Test"
