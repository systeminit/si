      ...
      actions: {
        ...
        async CREATE_BINDING(funcId: FuncId, bindings: FuncBinding[]) {
          ...
          return new ApiRequest<null>({
            method: "post",
            url: `${API_PREFIX}/${funcId}/binding/create`,
            params: {
              bindings,
            },
            onFail: () => {
        ...
        async UPDATE_BINDING(funcId: FuncId, bindings: FuncBinding[]) {
          ...
          return new ApiRequest<null>({
            method: "post",
            url: `${API_PREFIX}/${funcId}/binding/update`,
            params: {
              funcId,
              bindings,
            },
        ...
        async DELETE_BINDING(funcId: FuncId, bindings: FuncBinding[]) {
          ...
          return new ApiRequest<null>({
            method: "post",
            url: `${API_PREFIX}/${funcId}/binding/delete`,
            params: {
              bindings,
            },
            onFail: () => {
        ...
        realtimeStore.subscribe(this.$id, `changeset/${selectedChangeSetId}`, [
          ...
          },
          {
            ...
            callback: (data) => {
              ...
              this.funcsById[data.func_summary.funcId] = data.func_summary;
              const bindings = processBindings(data.func_summary);
              this.actionBindings[data.func_summary.funcId] =
                bindings.actionBindings;
              this.attributeBindings[data.func_summary.funcId] =
                bindings.attributeBindings;
              this.authenticationBindings[data.func_summary.funcId] =
                bindings.authenticationBindings;
              this.qualificationBindings[data.func_summary.funcId] =
                bindings.qualificationBindings;
              this.codegenBindings[data.func_summary.funcId] =
