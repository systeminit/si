...
import PanelEmpty from "@/organisms/PanelEmpty.vue";
import { SchematicKind } from "@/api/sdf/dal/schematic";
import { PanelAttributeSubType } from "./panel_types";

import PanelAttribute from "@/organisms/PanelAttribute.vue";
import PanelSchematic from "@/organisms/PanelSchematic.vue";
import PanelSecret from "@/organisms/PanelSecret.vue";
