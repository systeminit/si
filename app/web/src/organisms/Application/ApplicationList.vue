...
import ApplicationCreateForm from "@/organisms/Application/ApplicationCreateForm.vue";
...
import ApplicationCard from "@/organisms/Application/ApplicationCard.vue";
