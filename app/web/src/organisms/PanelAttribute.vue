...
import ProviderViewer from "@/organisms/ProviderViewer.vue";
import QualificationViewer from "@/organisms/QualificationViewer.vue";
import ResourceViewer from "@/organisms/ResourceViewer.vue";
