...
const filteredComponentsQueryKey = key(EntityKind.ComponentSearch, searchString);
watch(filteredComponentsQueryKey, () => {
  console.log(
    "filteredComponentsQueryKey changed",
    filteredComponentsQueryKey.value,
  );
});
...
const filteredComponentsQuery = useQuery({
  ...
  queryFn: async () => {
    ...
    console.log("returning filteredComponents", components);
    return components;
...
watch(filteredComponents, () => {
  console.log("filteredComponents changed", filteredComponents.value);
