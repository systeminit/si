<template>
  ...
  >
    <!--  HEADER  -->
    <div class="flex flex-row flex-none items-center justify-between w-full px-sm py-xs">
    ...
    <div class=" flex flex-row items-center grow w-full max-w-7xl px-lg gap-lg">
      ...
      <div class="flex-1 border basis-1/4 min-w-0 flex flex-col gap-sm ml-xl">
        <div class="text-xl">
    ...
    <!--  Bottom Links  -->
    <div class="flex flex-row flex-none w-full items-center justify-between px-lg py-sm gap-xs">
      <div>
        <span>Why is a credential necessary?</span>
        <span>I don't have a AWS Credential</span>
      </div>
      <div>These are links on the right</div>
    </div>
  </div>
</template>
