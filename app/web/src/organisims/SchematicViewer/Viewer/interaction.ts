...
import { SocketType } from "./geo";
import { SceneManager } from "./scene";
import * as ST from "../state";
import { Renderer } from "./renderer";
import { Interpreter } from "xstate";
import { SelectionManager } from "./interaction/selection";
import { DraggingManager } from "./interaction/dragging";
import { PanningManager } from "./interaction/panning";
import { ConnectingManager } from "./interaction/connecting";
import { ZoomingManager } from "./interaction/zooming";
...
export class InteractionManager {
  ...
  constructor(
    ...
    this.connectingManager = new ConnectingManager();
    this.zoomingManager = new ZoomingManager(sceneManager.root);
  ...
  onMouseDown(this: InteractionManager, e: PIXI.InteractionEvent) {
    ...
    if (target.kind === "node") {
      if (ST.isPanningActivated(this.stateService)) {
        ...
        const offset = {
          x: e.data.global.x - target.worldTransform.tx,
          y: e.data.global.y - target.worldTransform.ty,
        };
