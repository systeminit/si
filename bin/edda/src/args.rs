...
use edda_server::{Config, ConfigError, ConfigFile, StandardConfigFile};
...
/// Arguments for the edda service.
#[derive(Parser, Debug)]
...
pub(crate) struct Args {
    ...
    /// The ID of this edda instance [example: 01GWEAANW5BVFK5KDRVS6DEY0F"]
    #[arg(long)]
