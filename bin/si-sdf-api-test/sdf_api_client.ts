...
export const ROUTES = {
  ...
  abandon_change_set: {
    path: (vars: ROUTE_VARS) =>
      `/v2/workspaces/${vars.workspaceId}/change-sets/${vars.changeSetId}/abandon`,
    method: "POST",
  },
  force_apply: {
    path: (vars: ROUTE_VARS) =>
  ...
  create_change_set: {
    path: (vars: ROUTE_VARS) =>
      `/v2/workspaces/${vars.workspaceId}/change-sets/create_change_set`,
    method: "POST",
  },
  ...
  // Materialized Views --------------------------------------
  // TODO: Rename these other ones to say change_set_***
  index: {
    path: (vars: ROUTE_VARS) =>
  ...
  deployment_mjolnir: {
    path: (vars: ROUTE_VARS) => `v2/workspaces/${vars.workspaceId}/mjolnir`,
    method: "POST",
  },
