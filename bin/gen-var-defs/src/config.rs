...
impl Default for ConfigFile {
    fn default() -> Self {
        let cyclone_encryption_key_path = if let Ok(dir) = std::env::var("CARGO_MANIFEST_DIR") {
            ...
            panic!("gen var defs should only be run from cargo in a development environment");
        };
