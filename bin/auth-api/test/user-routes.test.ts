...
import { LATEST_TOS_VERSION_ID } from '../src/services/tos.service';
...
t.test('User routes', async () => {
  ...
  t.test('POST /tos-agreement - record agreement to TOS', async (t) => {
    ...
    const VERSION_1 = LATEST_TOS_VERSION_ID;
    const VERSION_2 = LATEST_TOS_VERSION_ID.replace('2023', '2024');
    const GOOD_PARAMS = {
