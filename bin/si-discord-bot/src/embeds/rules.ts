...
2. *New channels*:
We're happy to have new public channels on any topic related to cloud computing. Let a member of ${getRoleMention(
    "Team SI"
  )} know what you would like, and we'll take care of the rest.
`);
  return rulesMessage;
}
