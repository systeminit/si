...
We talk about all things related to cloud computing, software development, and other nerdy topics in ${getChannelMention("general")} and other channels in the "💬 PUBLIC 💬" category.

If you've been invited to become an ${getRoleMention("Agent")} - let us know who you are in ${getChannelMention("general")}.
