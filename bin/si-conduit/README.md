...
si-conduit
├── project
│   └── init                 - Initialize a new SI Conduit project
├── schema
...
Initialize a new SI Conduit project with the `project init` command:

```bash
# Initialize in current directory
si-conduit project init

# Initialize in a specific directory
si-conduit project init /path/to/project
...
1. Initialize a project using `si-conduit project init` if you haven't already
2. Verify `.conduitroot` exists in your project root directory
