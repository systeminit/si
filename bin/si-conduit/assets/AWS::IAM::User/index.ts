function main() {
  ...
  const userNameProp = new PropBuilder()
    ...
    .setDocLink("https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateUser.html#API_CreateUser_RequestParameters")
    .setDocumentation("The name of the user. Do not include the path in this value.\nIAM user, group, role, and policy names must be unique within the account. Names are not distinguished by case. For example, you cannot create resources named both `MyResource` and `myresource`.")
    .build();
  ...
  const pathProp = new PropBuilder()
    ...
    .setKind("string")
    .setDocLink("https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateUser.html#API_CreateUser_RequestParameters")
    .setDocumentation("The path to the group. For more information about paths, see [IAM identifiers](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html) in the IAM User Guide.\nThis parameter is optional. If it is not included, it defaults to a slash (/).\nThis parameter allows (through its [regex pattern](http://wikipedia.org/wiki/regex)) a string of characters consisting of either a forward slash (/) by itself or a string that must begin and end with forward slashes. In addition, it can contain any ASCII character from the ! (\u0021 ) through the DEL character (\u007F ), including most punctuation characters, digits, and upper and lowercased letters.")
    .build();
        ...
        .addChild(
          new PropBuilder()
            ...
            .setWidget(new PropWidgetDefinitionBuilder()
              ...
              .build())
            .setValidationFormat(Joi.string().required())
            .setDocLink("https://docs.aws.amazon.com/IAM/latest/APIReference/API_Tag.html")
