    ...
    .object({
      ...
      resource: z
        .object({
          ...
          lastSynced: z
            .string()
            .describe("the last time the resource was refreshed"),
        })
        .optional()
        .describe(
        ...
        .record(
          ...
          z
            .object({
              ...
              format: z
                .string()
                .describe("the language/format of the generated code"),
            })
      ...
      qualifications: z
        .record(
          ...
          z
            .object({
              result: z
                .enum(["failure", "success", "unknown", "warning"])
                .describe(
              ...
              message: z
                .string()
                .describe("the message about this qualification"),
            })
            .describe("the qualification result and message"),
        )
        .optional()
        .describe("optional qualification results"),
      actions: z
        .array(
          z.object({
            actionName: z.string().describe("the action function name"),
          }),
        )
...
const GetComponentOutputSchema = z.object(GetComponentOutputSchemaRaw);
        ...
        try {
          ...
          const attributes = _.pickBy(
            ...
            (_value: unknown, key: string) =>
              ...
              key.startsWith("/si/name") ||
              key.startsWith("/resource_value") ||
          ...
          for (const [path, resourceValue] of Object.entries(
            resourceAttributes,
          )) {
