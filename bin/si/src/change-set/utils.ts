/**
 * Change Set Utilities - Shared utilities for change set operations
 *
 * This module provides shared functionality for change set commands,
 * including resolution of change sets by ID or name.
 *
 * @module
 */
