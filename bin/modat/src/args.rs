...
use clap::Parser;
use modat_server::{Config, ConfigError, ConfigFile, StandardConfigFile};

const NAME: &str = "modat";
...
pub(crate) struct Args {
    ...
    pub(crate) bind_uds: Option<String>,
...
impl TryFrom<Args> for Config {
    ...
    fn try_from(args: Args) -> Result<Self, Self::Error> {
        ConfigFile::layered_load(NAME, |config_map| {
            if let Some(bind_uds) = args.bind_uds {
                config_map.set("bind_uds", bind_uds);
            }
