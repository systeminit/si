...
export const ACTION_FUNC_SPECS = {
  "Refresh Asset": {
    ...
    path: "./src/pipelines/entra/funcs/actions/refresh.ts",
  },
  "Create Asset": {
    ...
    path: "./src/pipelines/entra/funcs/actions/create.ts",
  },
  "Update Asset": {
    ...
    path: "./src/pipelines/entra/funcs/actions/update.ts",
  },
  "Delete Asset": {
    ...
    path: "./src/pipelines/entra/funcs/actions/delete.ts",
  },
...
export const MANAGEMENT_FUNCS = {
  "Discover on Microsoft Entra": {
    ...
    path: "./src/pipelines/entra/funcs/management/discover.ts",
    handlers: ["list", "read"],
  },
  "Import from Microsoft Entra": {
    ...
    path: "./src/pipelines/entra/funcs/management/import.ts",
    handlers: ["read"],
  },
} as const satisfies Record<
  string,
