...
CREATE OR REPLACE FUNCTION in_tenancy_v1(check_tenancy jsonb,
                                         ...
                                         this_tenancy_billing_account_pks bigint[],
                                         this_tenancy_organization_pks bigint[],
                                         this_tenancy_workspace_pks bigint[],
                                         OUT result bool
)
AS
$$
...
BEGIN
    ...
    RAISE DEBUG 'in_tenancy: % vs: u:% b:% o:% w:%', check_tenancy, this_tenancy_universal, this_tenancy_billing_account_pks, this_tenancy_organization_pks, this_tenancy_workspace_pks;

    empty_billing_account_list := cardinality(check_tenancy_record.tenancy_billing_account_pks) = 0;
    RAISE DEBUG 'empty_billing_account_list: %', empty_billing_account_list;
    empty_organization_list := cardinality(check_tenancy_record.tenancy_organization_pks) = 0;
    RAISE DEBUG 'empty_organization_list: %', empty_organization_list;
    empty_workspace_list := cardinality(check_tenancy_record.tenancy_workspace_pks) = 0;
    ...
    billing_account_check := (NOT empty_billing_account_list AND check_tenancy_record.tenancy_billing_account_pks <@ this_tenancy_billing_account_pks);
    RAISE DEBUG 'billing_account_check: %', billing_account_check;

    organization_check := (NOT empty_organization_list AND check_tenancy_record.tenancy_organization_pks <@ this_tenancy_organization_pks);
    RAISE DEBUG 'organization_check: %', organization_check;

    workspace_check := (NOT empty_workspace_list AND check_tenancy_record.tenancy_workspace_pks <@ this_tenancy_workspace_pks);
