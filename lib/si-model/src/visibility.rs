...
impl Visibility {
    ...
    #[tracing::instrument]
    pub fn new_edit_session(change_set_pk: ChangeSetPk, edit_session_pk: EditSessionPk, deleted: bool) -> Self {
        Visibility::new(change_set_pk, edit_session_pk, deleted)
    }

    #[tracing::instrument(skip(txn))]
    pub async fn is_visible_to(&self, txn: &PgTxn<'_>, check_visibility: &Visibility) -> VisibilityResult<bool> {
        let row = txn
            .query_one(
