...
pub struct JobExecutionRequestV3 {
    pub id: RequestId,
...
mod tests {
    ...
    fn msg_action() -> JobExecutionRequestV3 {
    ...
    fn msg_debug() -> JobExecutionRequestV3 {
        JobExecutionRequestV3 {
            id: "01JQCVVDHXYX6S9YCV773R13MG".parse().unwrap(),
            workspace_id: "01JVRJNMKGRDDSVQ5Y72R0R9F8".parse().unwrap(),
            change_set_id: "01JVRJSRHT964D53MWMTXYBXVK".parse().unwrap(),
            args: JobArgsV3::DebugFunc {
                debug_func_job_state_id: "01JVX336AZEFB82369PQGMCTM4".parse().unwrap(),
            },
            is_job_blocking: true,
        }
    }

    fn msg_dependent_values_update() -> JobExecutionRequestV3 {
        JobExecutionRequestV3 {
            id: "01JQCVVDHXYX6S9YCV773R13MG".parse().unwrap(),
            workspace_id: "01JVRJNMKGRDDSVQ5Y72R0R9F8".parse().unwrap(),
            change_set_id: "01JVRJSRHT964D53MWMTXYBXVK".parse().unwrap(),
            args: JobArgsV3::DependentValuesUpdate,
            is_job_blocking: true,
        }
    }

    fn msg_validation() -> JobExecutionRequestV3 {
        JobExecutionRequestV3 {
            id: "01JQCVVDHXYX6S9YCV773R13MG".parse().unwrap(),
            workspace_id: "01JVRJNMKGRDDSVQ5Y72R0R9F8".parse().unwrap(),
            change_set_id: "01JVRJSRHT964D53MWMTXYBXVK".parse().unwrap(),
            args: JobArgsV3::Validation {
    ...
    fn msg_management() -> JobExecutionRequestV3 {
        JobExecutionRequestV3 {
            id: "01JQCVVDHXYX6S9YCV773R13MG".parse().unwrap(),
            workspace_id: "01JVRJNMKGRDDSVQ5Y72R0R9F8".parse().unwrap(),
            change_set_id: "01JVRJSRHT964D53MWMTXYBXVK".parse().unwrap(),
            args: JobArgsV3::ManagementFunc {
    ...
    #[test]
    fn serialize_debug() {
        assert_serialize("serialized-debug", VERSION, msg_debug());
    }
    ...
    fn deserialize_debug() {
        assert_deserialize("serialized-debug", VERSION, msg_debug());
    }
