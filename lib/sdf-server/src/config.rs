...
pub struct Config {
    ...
    #[builder(default)]
    jwt_primary_signing_public_key: JwtConfig,
...
impl Config {
    ...
    #[must_use]
    pub fn jwt_primary_signing_public_key(&self) -> &JwtConfig {
        &self.jwt_primary_signing_public_key
    }
...
impl TryFrom<ConfigFile> for Config {
    ...
    fn try_from(mut value: ConfigFile) -> Result<Self> {
        ...
        Ok(Config {
            ...
            jwt_primary_signing_public_key: value.jwt_signing_public_key,
