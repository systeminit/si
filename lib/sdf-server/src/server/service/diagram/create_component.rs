...
use dal::{
    generate_name, Component, ComponentId, Schema, SchemaId, SchemaVariant, SchemaVariantId,
...
pub async fn create_component(
    ...
    let mut component = Component::new(&ctx, &name, request.schema_variant_id, None).await?;
