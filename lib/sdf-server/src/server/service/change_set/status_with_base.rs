...
use dal::{ChangeSet, Visibility, WorkspaceSnapshot, WorkspaceSnapshotError};
...
pub async fn status_with_base(
    ...
    Ok(Json(StatusWithBaseResponse {
        base_has_updates: !conflicts_and_updates_base_into_change_set
            .updates
            .is_empty(),
        change_set_has_updates: !conflicts_and_updates_change_set_into_base
            .updates
            .is_empty(),
        conflicts_with_base: !conflicts_and_updates_base_into_change_set
            .conflicts
            .is_empty()
            && !conflicts_and_updates_change_set_into_base
                .conflicts
                .is_empty(),
    }))
}
