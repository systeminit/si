...
pub use self::v1::UpdateRequestV1;

pub type UpdateRequestVCurrent = UpdateRequestV1;
...
impl ApiWrapper for UpdateRequest {
    type VersionsTarget = UpdateRequestVersions;
    type Current = UpdateRequestVCurrent;

    const MESSAGE_TYPE: &'static str = "UpdateRequest";

    fn id(&self) -> RequestId {
        match self {
            Self::V1(UpdateRequestVCurrent { id, .. }) => *id,
        }
    }
...
impl Deref for UpdateRequest {
    type Target = UpdateRequestVCurrent;
...
pub enum UpdateRequestVersions {
    V1(UpdateRequestV1),
}

impl ApiVersionsWrapper for UpdateRequestVersions {
    type Target = UpdateRequest;

    fn id(&self) -> RequestId {
        match self {
            Self::V1(UpdateRequestV1 { id, .. }) => *id,
        }
    }
...
mod test {
    ...
    use super::UpdateRequestVersionsDiscriminants;
    ...
    pub fn assert_serialize(
        name: &str,
        version: UpdateRequestVersionsDiscriminants,
