...
use si_pkg::{
    ...
    FuncSpecBackendKind, FuncSpecBackendResponseType, FuncSpecData, PkgSpec, PropSpec,
    PropSpecKind, PropSpecWidgetKind, SchemaSpec, SchemaVariantSpec, SchemaVariantSpecData, SiPkg,
    SocketSpec, SocketSpecData, SocketSpecKind,
};
