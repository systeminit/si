...
pub async fn get_variant(
    ...
    // Try DAL lookup first (installed schema variants)
        ...
        .await
    {
        ...
        Err(e) => {
            tracing::warn!("Failed to get MV for variant {}: {}", schema_variant_id, e);
            // If MV lookup fails, variant not found anywhere
        }
    }
