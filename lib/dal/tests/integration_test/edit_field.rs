use dal::component::Component;
use dal::edit_field::EditFieldAble;
use dal::edit_field::{EditField, EditFieldDataType};
use dal::test_harness::create_schema_variant_with_root;
use dal::{
    test_harness::{create_prop_of_kind_and_set_parent_with_name, create_schema},
