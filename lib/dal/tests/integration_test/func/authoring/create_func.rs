...
#[test]
async fn create_qualification_with_schema_variant_chainsaw(ctx: &mut DalContext) {
    let maybe_swifty_schema = Schema::find_by_name(ctx, "swifty")
        .await
        .expect("unable to get schema");
    assert!(maybe_swifty_schema.is_some());
...
#[test]
async fn create_codegen_with_schema_variant_chainsaw(ctx: &mut DalContext) {
    let maybe_swifty_schema = Schema::find_by_name(ctx, "swifty")
        .await
        .expect("unable to get schema");
    assert!(maybe_swifty_schema.is_some());
...
#[test]
async fn create_attribute_override_dynamic_func_for_prop_chainsaw(ctx: &mut DalContext) {
    let schema = Schema::find_by_name(ctx, "swifty")
        .await
        .expect("unable to find schema by name")
        .expect("schema not found");
...
#[test]
async fn create_attribute_override_dynamic_func_for_output_socket_chainsaw(ctx: &mut DalContext) {
    let schema = Schema::find_by_name(ctx, "swifty")
        .await
        .expect("unable to find schema by name")
        .expect("schema not found");
...
#[test]
async fn create_action_with_schema_variant_chainsaw(ctx: &mut DalContext) {
    let maybe_swifty_schema = Schema::find_by_name(ctx, "small even lego")
        .await
        .expect("unable to get schema");
    assert!(maybe_swifty_schema.is_some());
