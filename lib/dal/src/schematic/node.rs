...
use crate::{DalContext, Node, NodePosition, SchemaVariant, SchematicError, StandardModel};
            ...
            .map(|socket| {
                ...
                Self {
                    ...
                    direction: match socket.edge_kind() {
                        SocketEdgeKind::Output => SocketDirection::Output,
                    ...
                    node_side: match socket.edge_kind() {
                        SocketEdgeKind::Output => NodeSide::Right,
                        _ => NodeSide::Left,
                    },
                }
            })
