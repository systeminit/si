...
pub struct DeprecatedActionRunnerItem {
...
impl From<DeprecatedActionsJob> for DeprecatedActionsJobArgs {
    fn from(value: DeprecatedActionsJob) -> Self {
        Self {
...
impl JobProducer for DeprecatedActionsJob {
    fn arg(&self) -> JobProducerResult<serde_json::Value> {
        Ok(serde_json::to_value(DeprecatedActionsJobArgs::from(
            self.clone(),
        ))?)
    }
}

impl JobConsumerMetadata for DeprecatedActionsJob {
    fn type_name(&self) -> String {
        "DeprecatedActionsJob".to_string()
    }
...
#[async_trait]
impl JobConsumer for DeprecatedActionsJob {
    #[instrument(
    ...
    async fn run(&self, ctx: &mut DalContext) -> JobConsumerResult<JobCompletionState> {
        ...
        loop {
            ...
            if total_action_batch_loops >= total_action_limit {
                error!(
                    "DeprecatedActionRunner batch exceeded total action limit loops ({total_action_limit})! {:?}",
                    self
                );
                ...
                match action_task(ctx, self.batch_id, action_item, Span::current()).await {
                    ...
                    Err(err) => {
                        ...
                        process_failed_action(
                            ...
                            self.batch_id,
                            id,
                            format!("DeprecatedAction failed: {err}"),
                            Vec::new(),
                        )
                        .await;
                    }
...
impl TryFrom<JobInfo> for DeprecatedActionsJob {
    type Error = JobConsumerError;

    fn try_from(job: JobInfo) -> Result<Self, Self::Error> {
        let args = DeprecatedActionsJobArgs::deserialize(&job.arg)?;
...
async fn action_task(
    ctx: &mut DalContext,
    batch_id: DeprecatedActionBatchId,
    action_item: DeprecatedActionRunnerItem,
    parent_span: Span,
...
async fn process_failed_action(
    ctx: &DalContext,
    actions: &mut HashMap<DeprecatedActionRunnerId, DeprecatedActionRunnerItem>,
    batch_id: DeprecatedActionBatchId,
