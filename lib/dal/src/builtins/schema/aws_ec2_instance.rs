...
impl MigrationDriver {
    ...
    pub async fn migrate_aws_ec2_instance(
        ...
        FuncDescription::new(
            ...
            *schema_variant.id(),
            FuncDescriptionContents::Confirmation {
                name: "EC2 Instance Needs Deletion?".to_string(),
                success_description: Some("EC2 Instance doesn't need deletion!".to_string()),
                failure_description: Some(
                    "This EC2 Instance needs deletion. Please run the fix above to delete it!"
                        .to_string(),
                ),
                provider: Some("AWS".to_string()),
            },
        ...
        let delete_workflow_func_name = "si:awsEc2DeleteWorkflow";
