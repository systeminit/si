...
impl MigrationDriver {
    #[allow(dead_code)]
    pub async fn create_kubernetes_spec_prop(
        &self,
        ctx: &DalContext,
...

        {
...

            {
...

                {
                    ...
                    {
                        let _resource_field_ref_prop = self
                            .create_prop(
                                ctx,
                                "resourceFieldRef",
                                PropKind::Object,
...

            {
                ...
                // TODO: required
                let _image_pull_policy_prop = self
                    .create_prop(
                        ctx,
                        "imagePullPolicy",
                        PropKind::String,
        ...
        {
            let image_pull_secrets_prop = self
                .create_prop(
                    ctx,
                    "imagePullSecrets",
                    PropKind::Array,
