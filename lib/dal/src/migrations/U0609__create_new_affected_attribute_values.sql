        ...
        LOOP
            ...
            IF source_attribute_value.attribute_context_prop_id != ident_nil_v1() THEN
                ...
                FOR current_internal_provider_id,
                    ...
                    (WITH RECURSIVE parent_prop_tree
                                        AS (SELECT source_attribute_value.attribute_context_prop_id AS prop_id
                                            UNION ALL
            ...
            ELSIF source_attribute_value.attribute_context_internal_provider_id != ident_nil_v1() THEN
                ...
                LOOP
                    ...
                    insertion_attribute_context := jsonb_build_object(
                    ...
                    RAISE DEBUG 'attribute_value_create_new_affected_values_v1: AttributePrototype(%) on InternalProvider(%),Component(%) uses InternalProvider(%),Component(%)',
                        attribute_prototype_id, internal_provider_id, head_component_id, source_attribute_value.attribute_context_internal_provider_id, source_attribute_value.attribute_context_component_id;
