...
BEGIN
    ...
    INSERT INTO fix_batches (tenancy_billing_account_pks, tenancy_organization_pks,
                             tenancy_workspace_pks, visibility_change_set_pk, visibility_deleted_at, author)
