...
BEGIN
    ...
    INSERT INTO users (tenancy_universal, tenancy_billing_account_ids, tenancy_organization_ids, tenancy_workspace_ids,
                       visibility_change_set_pk, visibility_edit_session_pk, visibility_deleted_at, name, email, password)
    VALUES (this_tenancy_record.tenancy_universal, this_tenancy_record.tenancy_billing_account_ids,
            ...
            this_visibility_record.visibility_deleted_at, this_name, this_email, this_password)
