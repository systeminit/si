...
BEGIN
    ...
    ORDER BY attribute_values.attribute_context_prop_id, COALESCE(avbtav.belongs_to_id, -1),
             ...
             attribute_values.attribute_context_component_id DESC, attribute_values.attribute_context_system_id DESC;
...
CREATE
    OR REPLACE FUNCTION attribute_value_list_payload_for_read_context_v1(this_tenancy jsonb,
...
BEGIN
    ...
    SELECT attribute_value_id_for_prop_and_context_v1(
                   this_tenancy,
                   this_visibility,
                   this_context,
                   this_prop_id
    ...
    RETURN QUERY SELECT *
                 FROM attribute_value_list_payload_for_read_context_and_root_v1(this_tenancy, this_visibility,
                                                                                this_context,
