...
/// Contains the "diffs" for a given [`Component`]. Generated by [`Self::new()`].
#[derive(Deserialize, Serialize, Debug)]
pub struct ComponentDiff {
    pub component_id: ComponentId,
    /// The [`Component`]'s [`CodeView`] found in the current [`Visibility`](crate::Visibility).
    pub current: CodeView,
    /// The "diff(s)" between [`Component`]'s [`CodeViews`](CodeView) found on _head_ and found in the current
    /// [`Visibility`](crate::Visibility).
    ///
    /// This will be empty if the [`Component`] has been newly added.
