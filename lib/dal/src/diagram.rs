...
use crate::{
    ChangeSetPk, Component, ComponentId, DalContext, HistoryEventError, StandardModel,
    StandardModelError,
};
...
pub struct Diagram {
    /// The shape of assembled [`Node`](crate::Node) information to render diagram nodes.
    pub components: Vec<DiagramComponentView>,
    /// The shape of assembled [`Edge`](crate::Edge) information to render diagram edges.
