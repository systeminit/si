...
use si_events::{workspace_snapshot::Checksum, WorkspaceSnapshotAddress};
...
use crate::{
    ...
    workspace_snapshot::graph::detector::Change,
            ...
            for &mv_kind in &independent_mvs {
                match mv_kind {
                    ...
                    ReferenceKind::ViewList => {
                        if mv_kind != ReferenceKind::ViewList {
                            continue;
                        }
