...
WHERE in_tenancy_v1($1, validation_prototypes.tenancy_universal, validation_prototypes.tenancy_billing_account_ids, validation_prototypes.tenancy_organization_ids,
  ...
  AND is_visible_v1($2, validation_prototypes.visibility_change_set_pk, validation_prototypes.visibility_edit_session_pk, validation_prototypes.visibility_deleted_at)
