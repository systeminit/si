...
INNER JOIN qualification_prototypes ON
  ...
  AND in_tenancy_v1($1, qualification_prototypes.tenancy_universal, qualification_prototypes.tenancy_billing_account_ids, qualification_prototypes.tenancy_organization_ids, qualification_prototypes.tenancy_workspace_ids)
  AND is_visible_v1($2, qualification_prototypes.visibility_change_set_pk, qualification_prototypes.visibility_edit_session_pk, qualification_prototypes.visibility_deleted_at)
WHERE in_tenancy_v1($1, qualification_resolvers.tenancy_universal, qualification_resolvers.tenancy_billing_account_ids, qualification_resolvers.tenancy_organization_ids, qualification_resolvers.tenancy_workspace_ids)
  ...
  AND qualification_resolvers.component_id = $3
   AND (qualification_resolvers.system_id = $4 OR qualification_resolvers.system_id = -1)
	ORDER BY qualification_resolvers.id,
      ...
      qualification_resolvers.visibility_edit_session_pk DESC;
