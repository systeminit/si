...
WHERE in_tenancy_v1($1, func_binding_return_values.tenancy_universal, func_binding_return_values.tenancy_billing_account_ids, func_binding_return_values.tenancy_organization_ids,
  ...
  AND is_visible_v1($2, func_binding_return_values.visibility_change_set_pk, func_binding_return_values.visibility_edit_session_pk, func_binding_return_values.visibility_deleted_at)
  AND is_visible_v1($2,
