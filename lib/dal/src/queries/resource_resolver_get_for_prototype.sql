...
WHERE in_tenancy_v1($1, resource_resolvers.tenancy_universal, resource_resolvers.tenancy_billing_account_ids, resource_resolvers.tenancy_organization_ids,
  ...
  AND is_visible_v1($2, resource_resolvers.visibility_change_set_pk, resource_resolvers.visibility_edit_session_pk, resource_resolvers.visibility_deleted_at)
