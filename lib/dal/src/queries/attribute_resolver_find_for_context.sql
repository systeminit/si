...
WHERE in_tenancy_v1($1, attribute_resolvers.tenancy_universal, attribute_resolvers.tenancy_billing_account_ids,
                    attribute_resolvers.tenancy_organization_ids,
                    attribute_resolvers.tenancy_workspace_ids)
  AND is_visible_v1($2, attribute_resolvers.visibility_change_set_pk, attribute_resolvers.visibility_deleted_at)
