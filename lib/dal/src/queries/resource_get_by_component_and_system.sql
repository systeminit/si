...
WHERE in_tenancy_v1($1, resources.tenancy_universal, resources.tenancy_billing_account_ids,
                    resources.tenancy_organization_ids,
                    resources.tenancy_workspace_ids)
  AND is_visible_v1($2, resources.visibility_change_set_pk, resources.visibility_deleted_at)
