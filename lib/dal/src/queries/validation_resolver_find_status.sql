...
LEFT JOIN validation_resolvers
  ON validation_resolvers.attribute_value_id = attribute_values.id 
     AND validation_resolvers.func_binding_return_value_id = attribute_values.func_binding_return_value_id
     AND in_tenancy_v1($1, validation_resolvers.tenancy_universal, validation_resolvers.tenancy_billing_account_ids, validation_resolvers.tenancy_organization_ids, validation_resolvers.tenancy_workspace_ids)
...
WHERE in_tenancy_v1($1, attribute_values.tenancy_universal, attribute_values.tenancy_billing_account_ids, attribute_values.tenancy_organization_ids, attribute_values.tenancy_workspace_ids)
