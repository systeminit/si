...
WHERE in_tenancy_v1($1, code_generation_resolvers.tenancy_universal,
                    code_generation_resolvers.tenancy_billing_account_ids,
                    code_generation_resolvers.tenancy_organization_ids,
                    code_generation_resolvers.tenancy_workspace_ids)
  AND is_visible_v1($2, code_generation_resolvers.visibility_change_set_pk,
                    code_generation_resolvers.visibility_deleted_at)
  AND is_visible_v1($2,
