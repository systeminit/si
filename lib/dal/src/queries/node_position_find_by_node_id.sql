...
WHERE in_tenancy_v1($1, node_positions.tenancy_universal, node_positions.tenancy_billing_account_ids,
                    node_positions.tenancy_organization_ids,
                    node_positions.tenancy_workspace_ids)
  AND is_visible_v1($2, node_positions.visibility_change_set_pk, node_positions.visibility_deleted_at)
  AND CASE
