...
WHERE in_tenancy_v1($1, resource_prototypes.tenancy_universal, resource_prototypes.tenancy_billing_account_ids,
                    resource_prototypes.tenancy_organization_ids,
                    resource_prototypes.tenancy_workspace_ids)
  AND is_visible_v1($2, resource_prototypes.visibility_change_set_pk, resource_prototypes.visibility_deleted_at)
