...
impl ApprovalRequirementExt for WorkspaceSnapshotGraphV4 {
    fn approval_requirements_for_changes(
        ...
        for change in changes {
            ...
            // TODO(nick,jacob): this will be optional.
            let entity_node_index = self.get_node_index_by_id_opt(entity_id)?;

            // IF SOME --> added or removed
            // IF NONE --> deleted
            // IF NONE and ENTITY KIND is APPROVAL REQUIREMENT DEFINITION --> create virtual requirement
