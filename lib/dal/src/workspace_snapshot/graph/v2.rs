...
use crate::{
    workspace_snapshot::{
        ...
        graph::{detector::Update, MerkleTreeHash, WorkspaceSnapshotGraphError},
...
impl WorkspaceSnapshotGraphV2 {
    ...
    pub fn add_ordered_edge(
        ...
        edge_weight: EdgeWeight,
        to_node_index: NodeIndex,
    ) -> Result<(EdgeIndex, Option<EdgeIndex>)> {
    ...
    #[inline(always)]
    pub(crate) fn get_node_index_by_id(&self, id: impl Into<Ulid>) -> Result<NodeIndex> {
        let id = id.into();
