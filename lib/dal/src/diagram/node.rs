...
use veritech_client::{ActionRunRequest, ResourceStatus};
...
use crate::{
    Component, ComponentId, DalContext, HistoryActor, ProviderArity, Schema, SchemaId,
...
// use crate::{
//     history_event, ActionKind, ActionPrototype, ActionPrototypeContext, ActorView, Component, Node,
//     NodeId, SchemaVariant, StandardModel,
// };
            ...
            if !external_provider.ui_hidden() {
                socket_views.push(Self {
                    ...
                    max_connections: match external_provider.arity() {
                        ...
                        ProviderArity::Unenforced => {
                            panic!("this should only be possible for implicit internal providers")
                        }
                    },
