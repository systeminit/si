...
#[derive(
    Clone, Debug, Deserialize, Eq, Serialize, PartialEq, si_frontend_mv_types_macros::FrontendChecksum,
)]
...
#[derive(
    Clone, Debug, Deserialize, Serialize, Eq, PartialEq, si_frontend_mv_types_macros::FrontendChecksum,
)]
#[serde(rename_all = "camelCase")]
