/**
 * Prompt for extracting CloudFormation resource types
 *
 * Guides the AI in identifying all relevant AWS CloudFormation
 * resource types needed to fulfill a user's requirements.
 */
export const extractTypesPrompt = `# Role and Functionality
