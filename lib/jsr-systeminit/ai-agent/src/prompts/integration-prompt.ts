/**
 * Prompt for infrastructure prototyping integration
 *
 * Guides the AI in creating complete AWS infrastructure configurations
 * based on natural language requirements and generating a System Initiative
 * management function response.
 */
export const integrationPrompt = `# Role and Functionality
