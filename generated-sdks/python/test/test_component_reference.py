...
class TestComponentReference(unittest.TestCase):
    """ComponentReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComponentReference:
        """Test ComponentReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComponentReference`
        """
    ...
    def testComponentReference(self):
        """Test ComponentReference"""
