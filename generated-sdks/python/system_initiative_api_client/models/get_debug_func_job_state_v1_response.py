...
class GetDebugFuncJobStateV1Response(BaseModel):
    """
    ...
    state: StrictStr
    __properties: ClassVar[List[str]] = ["failure", "funcRunId", "id", "result", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDebugFuncJobStateV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDebugFuncJobStateV1Response from a dict"""
        if obj is None:
            return None
