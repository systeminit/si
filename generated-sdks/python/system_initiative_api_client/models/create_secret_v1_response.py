...
class CreateSecretV1Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSecretV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSecretV1Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "secret": SecretV1.from_dict(obj["secret"]) if obj.get("secret") is not None else None
        })
        return _obj
