...
class ActionReferenceOneOf1(BaseModel):
    """
    ActionReferenceOneOf1
    """ # noqa: E501
    action_prototype_id: StrictStr = Field(alias="actionPrototypeId")
    __properties: ClassVar[List[str]] = ["actionPrototypeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionReferenceOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionReferenceOneOf1 from a dict"""
        if obj is None:
            return None
