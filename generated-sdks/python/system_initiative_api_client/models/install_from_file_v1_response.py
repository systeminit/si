...
class InstallFromFileV1Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["category", "displayName", "schemaId", "schemaName", "schemaVariantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstallFromFileV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstallFromFileV1Response from a dict"""
        if obj is None:
            return None
