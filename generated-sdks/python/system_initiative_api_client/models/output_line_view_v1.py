...
class OutputLineViewV1(BaseModel):
    """
    OutputLineViewV1
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["executionId", "group", "level", "message", "stream", "timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutputLineViewV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutputLineViewV1 from a dict"""
        if obj is None:
            return None
