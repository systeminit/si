...
class CreateChangeSetV1Response(BaseModel):
    """
    CreateChangeSetV1Response
    """ # noqa: E501
    change_set: ChangeSetViewV1 = Field(alias="changeSet")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateChangeSetV1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateChangeSetV1Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "changeSet": ChangeSetViewV1.from_dict(obj["changeSet"]) if obj.get("changeSet") is not None else None
        })
        return _obj
