...
class ExecutionHistoryEntry(BaseModel):
    ...
    state: StrictStr
    __properties: ClassVar[List[str]] = ["funcRunId", "startedAt", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExecutionHistoryEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExecutionHistoryEntry from a dict"""
        if obj is None:
            return None
