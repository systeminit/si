...
class FunctionExecutionStatusV1(BaseModel):
    """
    ...
    has_active_run: StrictBool = Field(alias="hasActiveRun")
    state: StrictStr
    __properties: ClassVar[List[str]] = ["actionId", "funcRunId", "hasActiveRun", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FunctionExecutionStatusV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FunctionExecutionStatusV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hasActiveRun": obj.get("hasActiveRun"),
            "state": obj.get("state")
        })
        return _obj
