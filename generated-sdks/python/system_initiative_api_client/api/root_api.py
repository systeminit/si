...
class RootApi:
    ...
    def system_status_route(
        ...
        _param = self._system_status_route_serialize(
    ...
    @validate_call
    def system_status_route_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def system_status_route_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _system_status_route_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
