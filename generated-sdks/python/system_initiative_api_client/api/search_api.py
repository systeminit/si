...
class SearchApi:
    ...
    def search(
        ...
        q: Annotated[StrictStr, Field(description="Query string. See https://docs.systeminit.com/explanation/search-syntax for details.")],
        ...
        :param q: Query string. See https://docs.systeminit.com/explanation/search-syntax for details. (required)
        :type q: str
    ...
    def _search_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/w/{workspace_id}/change-sets/{change_set_id}/search',
