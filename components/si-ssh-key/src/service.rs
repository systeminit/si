...
use crate::ssh_key::{
    ...
    OrderByDirection, PageToken, Query, QueryBooleanLogic, QueryComparison, QueryExpression,
...
impl std::fmt::Display for KeyType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let msg = match self {
            ...
            &KeyType::Ed25519 => "ED25591".to_string(),
        };
        write!(f, "{}", msg)
    }
}
...
impl SshKey for Service {
    async fn get_component(
        ...
        let span = span!(Level::INFO, "get_component");
    ...
    async fn list_components(
        ...
        let span = span!(Level::INFO, "list_component");
        let _start_span = span.enter();
    ...
    async fn create_entity(
        ...
        let span = span!(Level::INFO, "create_entity");
        let _start_span = span.enter();
        event!(Level::INFO, ?request);
        let req = request.into_inner();
    ...
    async fn get_entity(
        ...
        let span = span!(Level::INFO, "get_entity");
        let _start_span = span.enter();
    ...
    async fn list_entities(
        ...
        let span = span!(Level::INFO, "list_entities");
        let _start_span = span.enter();
