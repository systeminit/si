...
impl crate::protobuf::EventLog {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        level: Option<crate::protobuf::EventLogLevel>,
        si_properties: Option<crate::protobuf::EventLogSiProperties>,
        message: Option<String>,
        payload: Option<crate::protobuf::EventLogPayload>,
        related_ids: Vec<String>,
        timestamp: Option<String>,
        created_by_user_id: Option<String>,
    ) -> si_data::Result<crate::protobuf::EventLog> {
        ...
        let mut result: crate::protobuf::EventLog = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::EventLog::new(
            name,
            display_name,
            level,
            si_properties,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::EventLog> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_event_log");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::EventLogListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::EventLog>> {
...
impl si_data::Storable for crate::protobuf::EventLog {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::EventLog.si_storable \
    ...
    fn validate(&self) -> si_data::error::Result<()> {
        ...
        if self.payload.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required payload value".into(),
            ));
        }
        if self.timestamp.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required timestamp value".into(),
            ));
        }
