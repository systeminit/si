...
impl crate::protobuf::Item {
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::Item> {
    ...
    pub async fn get_by_natural_key(
        db: &si_data::Db,
        natural_key: &str,
    ) -> si_data::Result<crate::protobuf::Item> {
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::ItemListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::Item>> {
...
impl si_data::Storable for crate::protobuf::Item {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::Item.si_storable \
