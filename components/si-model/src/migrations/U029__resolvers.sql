...
(
    ...
    schema_variant_id          bigint REFERENCES schema_variants (id),
    prop_variant_id            bigint REFERENCES prop_variants (id),
...
BEGIN
    ...
    SELECT si_id_to_primary_key_v1(this_prop_variant_si_id) INTO this_prop_variant_id;
    SELECT si_id_to_primary_key_v1(this_schema_variant_si_id) INTO this_schema_variant_id;
    ...
    SELECT jsonb_build_object(
                   ...
                   'schemaVariantId', this_schema_variant_si_id,
                   'siStorable', si_storable
               )
    INTO object;

    IF this_prop_variant_si_id IS NOT NULL THEN
        SELECT si_id_to_primary_key_v1(this_prop_variant_si_id) INTO this_prop_variant_id;
        SELECT jsonb_set(object, '{propVariantId}', to_jsonb(this_prop_variant_si_id), true) INTO object;
    END IF;
    ...
    IF this_parent_resolver_binding_si_id IS NOT NULL THEN
        ...
        SELECT jsonb_set(object, '{parentResolverBindingId}', to_jsonb(this_parent_resolver_binding_si_id), true)
        INTO object;
    END IF;
    ...
    IF this_change_set_si_id IS NOT NULL THEN
        ...
        SELECT jsonb_set(object, '{changeSetId}', to_jsonb(this_change_set_si_id), true) INTO object;
    END IF;
    ...
    IF this_edit_session_si_id IS NOT NULL THEN
        ...
        SELECT jsonb_set(object, '{editSessionId}', to_jsonb(this_edit_session_si_id), true) INTO object;
    END IF;
    ...
    INSERT INTO resolver_bindings (id, si_id, entity_id, system_id, change_set_id, edit_session_id, resolver_id,
                                   schema_variant_id, prop_variant_id, parent_resolver_binding_id, obj, created_at,
                                   updated_at)
    VALUES (id, si_id, this_entity_id, this_system_id, this_change_set_id, this_edit_session_id, this_resolver_id,
            this_schema_variant_id, this_prop_variant_id, this_parent_resolver_id, object, created_at, updated_at);
END;
$$ LANGUAGE PLPGSQL;
...
BEGIN
    ...
    INSERT INTO resolver_binding_values (id, si_id, resolver_binding_id, resolver_id, schema_variant_id, entity_id,
                                         system_id,
                                         prop_variant_id, parent_resolver_binding_id, change_set_id, edit_session_id,
                                         output_value, obj_value, obj,
                                         created_at, updated_at)
    VALUES (id, si_id, this_resolver_binding_id, this_resolver_id, this_schema_variant_id, this_entity_id,
            this_system_id,
            this_prop_variant_id, this_parent_resolver_binding_id, this_change_set_id, this_edit_session_id,
            this_output_value, this_obj_value, object,
            created_at, updated_at);
END;
$$ LANGUAGE PLPGSQL;
