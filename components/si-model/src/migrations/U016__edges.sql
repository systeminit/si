...
(
    ...
    tail_vertex_object_type  text                     NOT NULL,
    ...
    head_vertex_object_type  text                     NOT NULL,
    kind                     text                     NOT NULL,
    ...
    UNIQUE (workspace_id, tail_vertex_node_si_id, tail_vertex_object_si_id, tail_vertex_socket,
            head_vertex_node_si_id, head_vertex_object_si_id, head_vertex_socket, kind)
);
...
BEGIN
    ...
    SELECT jsonb_build_object(
                   ...
                   'objectType', this_head_vertex_object_type
               )
    ...
    SELECT jsonb_build_object(
                   ...
                   'objectType', this_tail_vertex_object_type
               )
    ...
    INSERT INTO edges (id, si_id, tail_vertex_node_si_id, tail_vertex_object_si_id, tail_vertex_socket,
                       tail_vertex_object_type,
                       head_vertex_node_si_id, head_vertex_object_si_id, head_vertex_socket, head_vertex_object_type,
                       kind,
                       billing_account_id, organization_id, workspace_id, tenant_ids, obj,
    ...
    VALUES (this_id, si_id, this_tail_vertex_node_si_id, this_tail_vertex_object_si_id, this_tail_vertex_socket,
            this_tail_vertex_object_type, this_head_vertex_node_si_id, this_head_vertex_object_si_id,
            this_head_vertex_socket,
            this_head_vertex_object_type, this_kind, this_billing_account_id, this_organization_id, this_workspace_id,
            tenant_ids, object, this_bidirectional, created_at, updated_at);
END;
