...
BEGIN
    ...
    INSERT INTO events (id, si_id, billing_account_id, organization_id, workspace_id, parent_id, epoch, update_count,
...
BEGIN
    ...
    UPDATE events
    SET epoch = (input_event -> 'siStorable' -> 'updateClock' ->> 'epoch')::bigint,
        update_count = (input_event -> 'siStorable' -> 'updateClock' ->> 'updateCount')::bigint,
        obj        = input_event,
        updated_at = NOW()
    WHERE id = this_id
