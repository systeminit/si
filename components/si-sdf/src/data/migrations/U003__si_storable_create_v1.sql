CREATE OR REPLACE FUNCTION si_storable_create_v1(si_id text, si_workspace_id text,
                                                 ...
                                                 this_updated_at timestamp with time zone, this_epoch bigint,
...
BEGIN
    ...
    SELECT jsonb_build_object(
                   'epoch', this_epoch,
                   'updateCount', this_update_count
               )
    INTO update_clock_object;
    ...
    SELECT jsonb_build_object(
                   ...
                   'updateClock', update_clock_object
               )
