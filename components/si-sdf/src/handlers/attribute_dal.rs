...
use si_model::{
    ...
    ApplicationEntities, Connection, Connections, Edge, EdgeKind, Entity, LabelList, LabelListItem,
    Qualification, Schematic, SchematicKind, Veritech,
};
