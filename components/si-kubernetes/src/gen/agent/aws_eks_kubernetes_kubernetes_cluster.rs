...
pub struct AwsEksKubernetesKubernetesClusterDispatcherBuilder<
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions,
> {
    dispatch_key: Option<si_agent::DispatchKey>,
    _phantom: std::marker::PhantomData<T>,
}

impl<T> si_agent::DispatchBuilder for AwsEksKubernetesKubernetesClusterDispatcherBuilder<T>
where
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions + Sync + Send + 'static,
{
    type Dispatchable = AwsEksKubernetesKubernetesClusterDispatcher<T>;
    ...
    fn object_type(&self) -> &'static str {
        "kubernetes_cluster_entity_event"
    }
}

pub struct AwsEksKubernetesKubernetesClusterDispatcher<
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions,
> {
...
impl<T> AwsEksKubernetesKubernetesClusterDispatcher<T>
where
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions,
{
    ...
    async fn dispatch_event(
        ...
        entity_event: &mut crate::protobuf::KubernetesClusterEntityEvent,
...
impl<T> si_agent::Dispatch for AwsEksKubernetesKubernetesClusterDispatcher<T>
where
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions + Sync + Send,
{
    async fn dispatch(
        &self,
        transport: &si_agent::Transport,
        ...
        let (_header, _qos, response_header, mut entity_event) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesClusterEntityEvent> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl<T> si_agent::Dispatchable for AwsEksKubernetesKubernetesClusterDispatcher<T> where
    T: AwsEksKubernetesKubernetesClusterDispatchFunctions + Sync + Send
{
}

#[async_trait::async_trait]
pub trait AwsEksKubernetesKubernetesClusterDispatchFunctions {
    async fn create(
        transport: &si_agent::Transport,
        stream_header: si_agent::Header,
        entity_event: &mut crate::protobuf::KubernetesClusterEntityEvent,
