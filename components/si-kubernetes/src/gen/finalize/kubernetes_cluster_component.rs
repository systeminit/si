...
struct KubernetesClusterComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesClusterComponentFinalizerBuilder {
    type Finalizeable = KubernetesClusterComponentFinalizer;
...
pub struct KubernetesClusterComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesClusterComponentFinalizer {
...
impl si_cea::Finalize for KubernetesClusterComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesClusterComponent> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for KubernetesClusterComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesClusterComponentFinalizer> {
    let mut builder = KubernetesClusterComponentFinalizerBuilder::new();
