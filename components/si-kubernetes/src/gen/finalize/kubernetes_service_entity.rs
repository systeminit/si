...
struct KubernetesServiceEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesServiceEntityFinalizerBuilder {
    type Finalizeable = KubernetesServiceEntityFinalizer;
...
pub struct KubernetesServiceEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesServiceEntityFinalizer {
...
impl si_cea::Finalize for KubernetesServiceEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_topic, object) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesServiceEntity> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for KubernetesServiceEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesServiceEntityFinalizer> {
    let mut builder = KubernetesServiceEntityFinalizerBuilder::new();
