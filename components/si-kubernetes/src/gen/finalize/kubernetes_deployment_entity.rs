...
struct KubernetesDeploymentEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesDeploymentEntityFinalizerBuilder {
    type Finalizeable = KubernetesDeploymentEntityFinalizer;
...
pub struct KubernetesDeploymentEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesDeploymentEntityFinalizer {
...
impl si_cea::Finalize for KubernetesDeploymentEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesDeploymentEntity> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for KubernetesDeploymentEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesDeploymentEntityFinalizer> {
    let mut builder = KubernetesDeploymentEntityFinalizerBuilder::new();
