...
struct KubernetesServiceComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesServiceComponentFinalizerBuilder {
    type Finalizeable = KubernetesServiceComponentFinalizer;
...
pub struct KubernetesServiceComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesServiceComponentFinalizer {
...
impl si_cea::Finalize for KubernetesServiceComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_topic, object) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesServiceComponent> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for KubernetesServiceComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesServiceComponentFinalizer> {
    let mut builder = KubernetesServiceComponentFinalizerBuilder::new();
