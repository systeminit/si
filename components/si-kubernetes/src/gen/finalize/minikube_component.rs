...
struct MinikubeComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for MinikubeComponentFinalizerBuilder {
    type Finalizeable = MinikubeComponentFinalizer;
...
pub struct MinikubeComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl MinikubeComponentFinalizer {
...
impl si_cea::Finalize for MinikubeComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::MinikubeComponent> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for MinikubeComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<MinikubeComponentFinalizer> {
    let mut builder = MinikubeComponentFinalizerBuilder::new();
