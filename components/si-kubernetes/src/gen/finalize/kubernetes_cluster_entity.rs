...
struct KubernetesClusterEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesClusterEntityFinalizerBuilder {
    type Finalizeable = KubernetesClusterEntityFinalizer;
...
pub struct KubernetesClusterEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesClusterEntityFinalizer {
...
impl si_cea::Finalize for KubernetesClusterEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::KubernetesClusterEntity> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for KubernetesClusterEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesClusterEntityFinalizer> {
    let mut builder = KubernetesClusterEntityFinalizerBuilder::new();
