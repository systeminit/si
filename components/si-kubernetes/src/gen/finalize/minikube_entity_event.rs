...
struct MinikubeEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for MinikubeEntityEventFinalizerBuilder {
    type Finalizeable = MinikubeEntityEventFinalizer;
...
pub struct MinikubeEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl MinikubeEntityEventFinalizer {
...
impl si_cea::Finalize for MinikubeEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for MinikubeEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<MinikubeEntityEventFinalizer> {
    let mut builder = MinikubeEntityEventFinalizerBuilder::new();
