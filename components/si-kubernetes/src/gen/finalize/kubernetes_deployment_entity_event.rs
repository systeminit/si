...
struct KubernetesDeploymentEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for KubernetesDeploymentEntityEventFinalizerBuilder {
    type Finalizeable = KubernetesDeploymentEntityEventFinalizer;
...
pub struct KubernetesDeploymentEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl KubernetesDeploymentEntityEventFinalizer {
...
impl si_cea::Finalize for KubernetesDeploymentEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for KubernetesDeploymentEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<KubernetesDeploymentEntityEventFinalizer> {
    let mut builder = KubernetesDeploymentEntityEventFinalizerBuilder::new();
