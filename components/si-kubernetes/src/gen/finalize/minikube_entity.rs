...
struct MinikubeEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for MinikubeEntityFinalizerBuilder {
    type Finalizeable = MinikubeEntityFinalizer;
...
pub struct MinikubeEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl MinikubeEntityFinalizer {
...
impl si_cea::Finalize for MinikubeEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::MinikubeEntity> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for MinikubeEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<MinikubeEntityFinalizer> {
    let mut builder = MinikubeEntityFinalizerBuilder::new();
