...
impl crate::protobuf::KubernetesServiceEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::KubernetesServiceComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::KubernetesServiceComponentConstraints>,
        properties: Option<crate::protobuf::KubernetesServiceEntityProperties>,
        ...
        let mut result: crate::protobuf::KubernetesServiceEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::KubernetesServiceEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::KubernetesServiceEntity> {
    ...
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::KubernetesServiceEntity>> {
...
impl si_cea::Entity for crate::protobuf::KubernetesServiceEntity {
    type EntityProperties = crate::protobuf::KubernetesServiceEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::KubernetesServiceEntity.si_properties \
...
impl si_data::Storable for crate::protobuf::KubernetesServiceEntity {
    ...
    fn order_by_fields() -> Vec<&'static str> {
        vec![
            ...
            "siStorable.naturalKey",
            "siStorable.naturalKey",
            "properties.kubernetesObject.apiVersion",
            "properties.kubernetesObject.kind",
            "siStorable.naturalKey",
            "properties.kubernetesObject.kubernetesMetadata.name",
            "properties.kubernetesObject.kubernetesMetadata.labels",
            "siStorable.naturalKey",
            "properties.kubernetesObject.spec.clusterIp",
            "properties.kubernetesObject.spec.externalIps",
            "properties.kubernetesObject.spec.externalName",
            "properties.kubernetesObject.spec.externalTrafficPolicy",
            "properties.kubernetesObject.spec.healthCheckNodePort",
            "properties.kubernetesObject.spec.ipFamily",
            "properties.kubernetesObject.spec.loadBalancerIp",
            "properties.kubernetesObject.spec.loadBalancerSourceRanges",
            "siStorable.naturalKey",
            "properties.kubernetesObject.spec.kubernetesServicePort.appProtocol",
            "properties.kubernetesObject.spec.kubernetesServicePort.name",
            "properties.kubernetesObject.spec.kubernetesServicePort.nodePort",
            "properties.kubernetesObject.spec.kubernetesServicePort.port",
            "properties.kubernetesObject.spec.kubernetesServicePort.protocol",
            "properties.kubernetesObject.spec.kubernetesServicePort.targetPort",
            "properties.kubernetesObject.spec.publishNotReadyAddress",
            "siStorable.naturalKey",
            "properties.kubernetesObject.spec.kubernetesSelector.matchLabels",
            "properties.kubernetesObject.spec.sessionAffinity",
            "siStorable.naturalKey",
            "siStorable.naturalKey",
            "properties.kubernetesObject.spec.sessionAffinityConfig.clientIp.timeoutSeconds",
            "properties.kubernetesObject.spec.topologyKeys",
            "properties.kubernetesObject.spec.type",
            "siStorable.naturalKey",
            "siStorable.naturalKey",
            "siStorable.naturalKey",
            "properties.kubernetesObject.status.kubernetesLoadBalancerStatus.ingress.hostname",
            "properties.kubernetesObject.status.kubernetesLoadBalancerStatus.ingress.ip",
            "properties.kubernetesObjectYaml",
            "siStorable.naturalKey",
