...
impl crate::protobuf::KubernetesServiceComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::KubernetesServiceComponent> {
        ...
        let mut result: crate::protobuf::KubernetesServiceComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::KubernetesServiceComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_kubernetes_service_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::KubernetesServiceComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::KubernetesServiceComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::KubernetesServiceComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::KubernetesServiceComponentConstraints, Self)>>
    {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::KubernetesServiceComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::KubernetesServiceComponent {
    fn type_name() -> &'static str {
        "kubernetes_service_component"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::KubernetesServiceComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::KubernetesServiceComponent {
...
impl crate::protobuf::KubernetesServiceComponentConstraintsKubernetesVersion {
...
impl std::fmt::Display for crate::protobuf::KubernetesServiceComponentConstraintsKubernetesVersion {
...
#[error("invalid KubernetesServiceComponentConstraintsKubernetesVersion value: {0}")]
pub struct InvalidKubernetesServiceComponentConstraintsKubernetesVersion(String);

impl std::str::FromStr for crate::protobuf::KubernetesServiceComponentConstraintsKubernetesVersion {
    type Err = InvalidKubernetesServiceComponentConstraintsKubernetesVersion;
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        match s {
            ...
            "v1.15" => Ok(Self::V115),
            invalid => Err(
                InvalidKubernetesServiceComponentConstraintsKubernetesVersion(invalid.to_string()),
            ),
        }
    }
}
