...
impl crate::protobuf::MinikubeEntityEvent {
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::MinikubeEntityEvent> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_minikube_entity_event");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::MinikubeEntityEventListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::MinikubeEntityEvent>> {
...
impl si_cea::EntityEvent for crate::protobuf::MinikubeEntityEvent {
    type Entity = crate::protobuf::MinikubeEntity;
    ...
    fn set_billing_account_id(&mut self, billing_account_id: impl Into<String>) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::MinikubeEntityEvent.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::MinikubeEntityEvent {
    fn type_name() -> &'static str {
        "minikube_entity_event"
    }
}

impl si_data::Storable for crate::protobuf::MinikubeEntityEvent {
    fn type_name() -> &'static str {
        "minikube_entity_event"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::MinikubeEntityEvent.si_storable \
                has been set or initialized",
        );
