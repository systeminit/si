...
impl crate::protobuf::MinikubeEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::MinikubeComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::MinikubeComponentConstraints>,
        properties: Option<crate::protobuf::MinikubeEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::MinikubeEntity> {
        ...
        let mut result: crate::protobuf::MinikubeEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::MinikubeEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::MinikubeEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_minikube_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::MinikubeEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::MinikubeEntity>> {
    ...
    pub async fn update(
        ...
        db: &si_data::Db,
        change_set_id: Option<String>,
        update: Option<crate::protobuf::MinikubeEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::MinikubeEntity {
    type EntityProperties = crate::protobuf::MinikubeEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::MinikubeEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::MinikubeEntity {
    fn type_name() -> &'static str {
        "minikube_entity"
    }
}

impl si_data::Storable for crate::protobuf::MinikubeEntity {
    fn type_name() -> &'static str {
        "minikube_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::MinikubeEntity.si_storable \
                has been set or initialized",
        );
