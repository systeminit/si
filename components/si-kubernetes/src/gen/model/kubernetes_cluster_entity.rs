...
impl crate::protobuf::KubernetesClusterEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::KubernetesClusterComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::KubernetesClusterComponentConstraints>,
        properties: Option<crate::protobuf::KubernetesClusterEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::KubernetesClusterEntity> {
        ...
        let mut result: crate::protobuf::KubernetesClusterEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::KubernetesClusterEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::KubernetesClusterEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_kubernetes_cluster_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::KubernetesClusterEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::KubernetesClusterEntity>> {
    ...
    pub async fn update(
        ...
        db: &si_data::Db,
        change_set_id: Option<String>,
        update: Option<crate::protobuf::KubernetesClusterEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::KubernetesClusterEntity {
    type EntityProperties = crate::protobuf::KubernetesClusterEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::KubernetesClusterEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::KubernetesClusterEntity {
    fn type_name() -> &'static str {
        "kubernetes_cluster_entity"
    }
}

impl si_data::Storable for crate::protobuf::KubernetesClusterEntity {
    fn type_name() -> &'static str {
        "kubernetes_cluster_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::KubernetesClusterEntity.si_storable \
                has been set or initialized",
        );
