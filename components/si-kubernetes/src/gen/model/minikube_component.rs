...
impl crate::protobuf::MinikubeComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::MinikubeComponent> {
        ...
        let mut result: crate::protobuf::MinikubeComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::MinikubeComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_minikube_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::MinikubeComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::MinikubeComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::MinikubeComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::MinikubeComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::MinikubeComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::MinikubeComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::MinikubeComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::MinikubeComponent {
