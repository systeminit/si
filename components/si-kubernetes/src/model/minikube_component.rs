use crate::protobuf::MinikubeComponentConstraints;
use si_cea::component::prelude::*;

type Constraints = MinikubeComponentConstraints;

pub use crate::protobuf::MinikubeComponent;

impl MinikubeComponent {
    pub async fn pick(db: &Db, constraints: Option<Constraints>) -> CeaResult<(Constraints, Self)> {
        let span = tracing_pick_span!("minikube", &constraints);
        async {
