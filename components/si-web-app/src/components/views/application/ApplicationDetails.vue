...
export default {
  ...
  methods: {
    execute() {  
      try {
        let mutation = registry.get("kubernetesDeploymentEntity").graphql.mutation({methodName: "apply"})
        let variables = registry.get("kubernetesDeploymentEntity").graphql.variablesObject({ methodName: "apply"})
