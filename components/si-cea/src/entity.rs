use crate::component::SiProperties;
...
pub use crate::protobuf::entity::{EntitySiProperties, EntitySiPropertiesEntityState};
...
impl EntitySiProperties {
    pub fn new(workspace: &Workspace, csp: &SiProperties, component_id: impl Into<String>) -> Self {
        Self {
