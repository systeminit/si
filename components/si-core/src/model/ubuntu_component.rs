use crate::protobuf::UbuntuComponentConstraints;
use si_cea::component::prelude::*;

type Constraints = UbuntuComponentConstraints;

pub use crate::protobuf::UbuntuComponent;

impl UbuntuComponent {
    pub async fn pick(db: &Db, constraints: Option<Constraints>) -> CeaResult<(Constraints, Self)> {
        let span = tracing_pick_span!("ubuntu", &constraints);
        async {
