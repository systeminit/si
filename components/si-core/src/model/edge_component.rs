use crate::protobuf::EdgeComponentConstraints;
use si_cea::component::prelude::*;

type Constraints = EdgeComponentConstraints;

pub use crate::protobuf::EdgeComponent;
...
impl EdgeComponent {
    ...
    pub async fn migrate(db: &Db) -> DataResult<()> {
        ...
        // This will eventually need to be reflective of the edgeKinds
        let mut c = Self {
