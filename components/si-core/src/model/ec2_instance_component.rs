use crate::protobuf::Ec2InstanceComponentConstraints;
use si_cea::component::prelude::*;

type Constraints = Ec2InstanceComponentConstraints;

pub use crate::protobuf::Ec2InstanceComponent;

impl Ec2InstanceComponent {
    pub async fn pick(db: &Db, constraints: Option<Constraints>) -> CeaResult<(Constraints, Self)> {
        let span = tracing_pick_span!("ec2Instance", &constraints);
        async {
