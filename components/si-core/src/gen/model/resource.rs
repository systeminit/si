...
impl crate::protobuf::Resource {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        si_properties: Option<crate::protobuf::ResourceSiProperties>,
        ...
        data: Option<String>,
    ) -> si_data::Result<crate::protobuf::Resource> {
        ...
        let mut result: crate::protobuf::Resource = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::Resource::new(
            name,
            display_name,
            si_properties,
            entity_id,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::Resource> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_resource");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::ResourceListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::Resource>> {
...
impl si_data::Storable for crate::protobuf::Resource {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::Resource.si_storable \
    ...
    fn validate(&self) -> si_data::error::Result<()> {
        ...
        if self.node_id.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required node_id value".into(),
            ));
        }
        if self.kind.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required kind value".into(),
            ));
        }
        if self.status.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required status value".into(),
            ));
        }
        if self.health.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required health value".into(),
            ));
        }
        if self.data.is_none() {
            return Err(si_data::DataError::ValidationError(
                "missing required data value".into(),
            ));
        }
