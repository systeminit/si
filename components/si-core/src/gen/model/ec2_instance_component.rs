...
impl crate::protobuf::Ec2InstanceComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::Ec2InstanceComponent> {
        ...
        let mut result: crate::protobuf::Ec2InstanceComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::Ec2InstanceComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_ec2_instance_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::Ec2InstanceComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::Ec2InstanceComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::Ec2InstanceComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::Ec2InstanceComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::Ec2InstanceComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::Ec2InstanceComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::Ec2InstanceComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::Ec2InstanceComponent {
