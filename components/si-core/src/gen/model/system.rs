...
impl crate::protobuf::System {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        si_properties: Option<crate::protobuf::SystemSiProperties>,
    ) -> si_data::Result<crate::protobuf::System> {
        ...
        let mut result: crate::protobuf::System = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::System::new(name, display_name, si_properties)?;
        db.validate_and_insert_as_new(&mut result).await?;

        Ok(result)
    }

    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::System> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_system");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::SystemListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::System>> {
...
impl si_data::Storable for crate::protobuf::System {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::System.si_storable \
