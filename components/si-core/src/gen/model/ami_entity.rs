...
impl crate::protobuf::AmiEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::AmiComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::AmiComponentConstraints>,
        properties: Option<crate::protobuf::AmiEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::AmiEntity> {
        ...
        let mut result: crate::protobuf::AmiEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::AmiEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::AmiEntity> {
    ...
    pub async fn get_by_natural_key(
        db: &si_data::Db,
        natural_key: &str,
    ) -> si_data::Result<crate::protobuf::AmiEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_ami_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::AmiEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::AmiEntity>> {
    ...
    pub async fn update(
        ...
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
        update: Option<crate::protobuf::AmiEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::AmiEntity {
    type EntityProperties = crate::protobuf::AmiEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::AmiEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::AmiEntity {
    fn type_name() -> &'static str {
        "ami_entity"
    }
}

impl si_data::Storable for crate::protobuf::AmiEntity {
    fn type_name() -> &'static str {
        "ami_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::AmiEntity.si_storable \
                has been set or initialized",
        );
