...
impl crate::protobuf::EdgeComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::EdgeComponent> {
        ...
        let mut result: crate::protobuf::EdgeComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::EdgeComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_edge_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::EdgeComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::EdgeComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::EdgeComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::EdgeComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::EdgeComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::EdgeComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::EdgeComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::EdgeComponent {
...
impl crate::protobuf::EdgeComponentConstraintsEdgeKind {
...
impl std::fmt::Display for crate::protobuf::EdgeComponentConstraintsEdgeKind {
...
#[error("invalid EdgeComponentConstraintsEdgeKind value: {0}")]
pub struct InvalidEdgeComponentConstraintsEdgeKind(String);

impl std::str::FromStr for crate::protobuf::EdgeComponentConstraintsEdgeKind {
    type Err = InvalidEdgeComponentConstraintsEdgeKind;

    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        match s {
            "connected" => Ok(Self::Connected),
            invalid => Err(InvalidEdgeComponentConstraintsEdgeKind(invalid.to_string())),
        }
    }
}
