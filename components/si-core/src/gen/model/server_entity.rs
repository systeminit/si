...
impl crate::protobuf::ServerEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::ServerComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::ServerComponentConstraints>,
        properties: Option<crate::protobuf::ServerEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::ServerEntity> {
        ...
        let mut result: crate::protobuf::ServerEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::ServerEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::ServerEntity> {
    ...
    pub async fn get_by_natural_key(
        db: &si_data::Db,
        natural_key: &str,
    ) -> si_data::Result<crate::protobuf::ServerEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_server_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::ServerEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::ServerEntity>> {
    ...
    pub async fn update(
        ...
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
        update: Option<crate::protobuf::ServerEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::ServerEntity {
    type EntityProperties = crate::protobuf::ServerEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::ServerEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::ServerEntity {
    fn type_name() -> &'static str {
        "server_entity"
    }
}

impl si_data::Storable for crate::protobuf::ServerEntity {
    fn type_name() -> &'static str {
        "server_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::ServerEntity.si_storable \
                has been set or initialized",
        );
