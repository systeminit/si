...
impl crate::protobuf::AmiComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::AmiComponent> {
        ...
        let mut result: crate::protobuf::AmiComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::AmiComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::AmiComponent> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_ami_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::AmiComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::AmiComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::AmiComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::AmiComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::AmiComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::AmiComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::AmiComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::AmiComponent {
