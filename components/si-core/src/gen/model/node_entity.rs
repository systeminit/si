...
impl crate::protobuf::NodeEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::NodeComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::NodeComponentConstraints>,
        properties: Option<crate::protobuf::NodeEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::NodeEntity> {
        ...
        let mut result: crate::protobuf::NodeEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::NodeEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::NodeEntity> {
    ...
    pub async fn get_by_natural_key(
        db: &si_data::Db,
        natural_key: &str,
    ) -> si_data::Result<crate::protobuf::NodeEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_node_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::NodeEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::NodeEntity>> {
    ...
    pub async fn update(
        ...
        db: &si_data::Db,
        change_set_id: Option<String>,
        update: Option<crate::protobuf::NodeEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::NodeEntity {
    type EntityProperties = crate::protobuf::NodeEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::NodeEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::NodeEntity {
    fn type_name() -> &'static str {
        "node_entity"
    }
}

impl si_data::Storable for crate::protobuf::NodeEntity {
    fn type_name() -> &'static str {
        "node_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::NodeEntity.si_storable \
                has been set or initialized",
        );
