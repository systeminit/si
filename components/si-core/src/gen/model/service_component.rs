...
impl crate::protobuf::ServiceComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::ServiceComponent> {
        ...
        let mut result: crate::protobuf::ServiceComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::ServiceComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::ServiceComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::ServiceComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::ServiceComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::ServiceComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::ServiceComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::ServiceComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::ServiceComponent {
