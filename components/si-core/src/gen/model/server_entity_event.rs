...
impl crate::protobuf::ServerEntityEvent {
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::ServerEntityEvent> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_server_entity_event");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::ServerEntityEventListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::ServerEntityEvent>> {
...
impl si_cea::EntityEvent for crate::protobuf::ServerEntityEvent {
    type Entity = crate::protobuf::ServerEntity;
    ...
    fn set_billing_account_id(&mut self, billing_account_id: impl Into<String>) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::ServerEntityEvent.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::ServerEntityEvent {
    fn type_name() -> &'static str {
        "server_entity_event"
    }
}

impl si_data::Storable for crate::protobuf::ServerEntityEvent {
    fn type_name() -> &'static str {
        "server_entity_event"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::ServerEntityEvent.si_storable \
                has been set or initialized",
        );
