...
impl crate::protobuf::Ec2InstanceEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::Ec2InstanceComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::Ec2InstanceComponentConstraints>,
        properties: Option<crate::protobuf::Ec2InstanceEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::Ec2InstanceEntity> {
        ...
        let mut result: crate::protobuf::Ec2InstanceEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::Ec2InstanceEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(
        db: &si_data::Db,
        id: &str,
    ) -> si_data::Result<crate::protobuf::Ec2InstanceEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_ec2_instance_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::Ec2InstanceEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::Ec2InstanceEntity>> {
    ...
    pub async fn update(
        ...
        change_set_id: Option<String>,
        edit_session_id: Option<String>,
        update: Option<crate::protobuf::Ec2InstanceEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::Ec2InstanceEntity {
    type EntityProperties = crate::protobuf::Ec2InstanceEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::Ec2InstanceEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::Ec2InstanceEntity {
    fn type_name() -> &'static str {
        "ec2_instance_entity"
    }
}

impl si_data::Storable for crate::protobuf::Ec2InstanceEntity {
    fn type_name() -> &'static str {
        "ec2_instance_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::Ec2InstanceEntity.si_storable \
                has been set or initialized",
        );
