...
impl crate::protobuf::ServerComponent {
    pub fn new(
        name: Option<String>,
    ...
    ) -> si_data::Result<crate::protobuf::ServerComponent> {
        ...
        let mut result: crate::protobuf::ServerComponent = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::ServerComponent::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_server_component");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::ServerComponentListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::ServerComponent>> {
    ...
    pub async fn pick_by_component_name(
        db: &si_data::Db,
        req: &crate::protobuf::ServerComponentConstraints,
    ) -> si_data::Result<Option<(crate::protobuf::ServerComponentConstraints, Self)>> {
        match &req.component_name {
            Some(name) => match Self::pick_by_string_field(db, "name", name).await? {
                Some(component) => Ok(Some((
                    crate::protobuf::ServerComponentConstraints::default(),
                    component,
                ))),
                None => Ok(None),
            },
...
impl si_data::Storable for crate::protobuf::ServerComponent {
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::ServerComponent.si_storable \
...
impl si_data::Migrateable for crate::protobuf::ServerComponent {
