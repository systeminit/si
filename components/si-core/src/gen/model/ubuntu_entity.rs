...
impl crate::protobuf::UbuntuEntity {
    pub fn new(
        name: Option<String>,
        display_name: Option<String>,
        description: Option<String>,
        constraints: Option<crate::protobuf::UbuntuComponentConstraints>,
        implicit_constraints: Option<crate::protobuf::UbuntuComponentConstraints>,
        properties: Option<crate::protobuf::UbuntuEntityProperties>,
        si_properties: Option<si_cea::protobuf::EntitySiProperties>,
        change_set_id: Option<String>,
    ) -> si_cea::CeaResult<crate::protobuf::UbuntuEntity> {
        ...
        let mut result: crate::protobuf::UbuntuEntity = Default::default();
        result.name = name;
    ...
    pub async fn create(
        ...
        let mut result = crate::protobuf::UbuntuEntity::new(
            name,
            display_name,
            description,
            constraints,
    ...
    pub async fn get(db: &si_data::Db, id: &str) -> si_data::Result<crate::protobuf::UbuntuEntity> {
    ...
    pub async fn get_by_natural_key(
        db: &si_data::Db,
        natural_key: &str,
    ) -> si_data::Result<crate::protobuf::UbuntuEntity> {
    ...
    pub async fn finalize(&self, db: &si_data::Db) -> si_data::Result<()> {
        tracing::debug!("finalizing_ubuntu_entity");
        db.upsert(self).await?;
    ...
    pub async fn list(
        db: &si_data::Db,
        list_request: crate::protobuf::UbuntuEntityListRequest,
    ) -> si_data::Result<si_data::ListResult<crate::protobuf::UbuntuEntity>> {
    ...
    pub async fn update(
        ...
        db: &si_data::Db,
        change_set_id: Option<String>,
        update: Option<crate::protobuf::UbuntuEntityUpdateRequestUpdate>,
    ) -> si_cea::CeaResult<()> {
...
impl si_cea::Entity for crate::protobuf::UbuntuEntity {
    type EntityProperties = crate::protobuf::UbuntuEntityProperties;
    ...
    fn set_entity_state(&mut self, state: si_cea::EntitySiPropertiesEntityState) {
        ...
        let si_properties = self.si_properties.as_mut().expect(
            "crate::protobuf::UbuntuEntity.si_properties \
...
impl si_agent::TypeHint for crate::protobuf::UbuntuEntity {
    fn type_name() -> &'static str {
        "ubuntu_entity"
    }
}

impl si_data::Storable for crate::protobuf::UbuntuEntity {
    fn type_name() -> &'static str {
        "ubuntu_entity"
    }
    ...
    fn set_type_name(&mut self) {
        ...
        let si_storable = self.si_storable.as_mut().expect(
            "crate::protobuf::UbuntuEntity.si_storable \
                has been set or initialized",
        );
