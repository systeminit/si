...
struct SystemEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for SystemEntityFinalizerBuilder {
    type Finalizeable = SystemEntityFinalizer;
...
pub struct SystemEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl SystemEntityFinalizer {
...
impl si_cea::Finalize for SystemEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for SystemEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<SystemEntityFinalizer> {
    let mut builder = SystemEntityFinalizerBuilder::new();
