...
struct UbuntuComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for UbuntuComponentFinalizerBuilder {
    type Finalizeable = UbuntuComponentFinalizer;
...
pub struct UbuntuComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl UbuntuComponentFinalizer {
...
impl si_cea::Finalize for UbuntuComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::UbuntuComponent> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for UbuntuComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<UbuntuComponentFinalizer> {
    let mut builder = UbuntuComponentFinalizerBuilder::new();
