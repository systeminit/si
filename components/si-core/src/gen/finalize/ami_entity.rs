...
struct AmiEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for AmiEntityFinalizerBuilder {
    type Finalizeable = AmiEntityFinalizer;
...
pub struct AmiEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl AmiEntityFinalizer {
...
impl si_cea::Finalize for AmiEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::AmiEntity> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for AmiEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<AmiEntityFinalizer> {
    let mut builder = AmiEntityFinalizerBuilder::new();
