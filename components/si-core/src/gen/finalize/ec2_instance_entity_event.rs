...
struct Ec2InstanceEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for Ec2InstanceEntityEventFinalizerBuilder {
    type Finalizeable = Ec2InstanceEntityEventFinalizer;
...
pub struct Ec2InstanceEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl Ec2InstanceEntityEventFinalizer {
...
impl si_cea::Finalize for Ec2InstanceEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for Ec2InstanceEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<Ec2InstanceEntityEventFinalizer> {
    let mut builder = Ec2InstanceEntityEventFinalizerBuilder::new();
