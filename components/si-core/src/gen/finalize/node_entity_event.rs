...
struct NodeEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for NodeEntityEventFinalizerBuilder {
    type Finalizeable = NodeEntityEventFinalizer;
...
pub struct NodeEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl NodeEntityEventFinalizer {
...
impl si_cea::Finalize for NodeEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for NodeEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<NodeEntityEventFinalizer> {
    let mut builder = NodeEntityEventFinalizerBuilder::new();
