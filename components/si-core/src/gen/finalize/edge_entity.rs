...
struct EdgeEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for EdgeEntityFinalizerBuilder {
    type Finalizeable = EdgeEntityFinalizer;
...
pub struct EdgeEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl EdgeEntityFinalizer {
...
impl si_cea::Finalize for EdgeEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::EdgeEntity> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for EdgeEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<EdgeEntityFinalizer> {
    let mut builder = EdgeEntityFinalizerBuilder::new();
