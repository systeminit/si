...
struct ServiceComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for ServiceComponentFinalizerBuilder {
    type Finalizeable = ServiceComponentFinalizer;
...
pub struct ServiceComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl ServiceComponentFinalizer {
...
impl si_cea::Finalize for ServiceComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::ServiceComponent> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for ServiceComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<ServiceComponentFinalizer> {
    let mut builder = ServiceComponentFinalizerBuilder::new();
