...
struct ApplicationComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for ApplicationComponentFinalizerBuilder {
    type Finalizeable = ApplicationComponentFinalizer;
...
pub struct ApplicationComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl ApplicationComponentFinalizer {
...
impl si_cea::Finalize for ApplicationComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_topic, object) = {
            let msg: si_agent::Message<crate::protobuf::ApplicationComponent> =
                message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for ApplicationComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<ApplicationComponentFinalizer> {
    let mut builder = ApplicationComponentFinalizerBuilder::new();
