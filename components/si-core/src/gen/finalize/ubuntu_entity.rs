...
struct UbuntuEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for UbuntuEntityFinalizerBuilder {
    type Finalizeable = UbuntuEntityFinalizer;
...
pub struct UbuntuEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl UbuntuEntityFinalizer {
...
impl si_cea::Finalize for UbuntuEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::UbuntuEntity> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for UbuntuEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<UbuntuEntityFinalizer> {
    let mut builder = UbuntuEntityFinalizerBuilder::new();
