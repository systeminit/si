...
struct AmiEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for AmiEntityEventFinalizerBuilder {
    type Finalizeable = AmiEntityEventFinalizer;
...
pub struct AmiEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl AmiEntityEventFinalizer {
...
impl si_cea::Finalize for AmiEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for AmiEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<AmiEntityEventFinalizer> {
    let mut builder = AmiEntityEventFinalizerBuilder::new();
