...
struct ServerEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for ServerEntityEventFinalizerBuilder {
    type Finalizeable = ServerEntityEventFinalizer;
...
pub struct ServerEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl ServerEntityEventFinalizer {
...
impl si_cea::Finalize for ServerEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for ServerEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<ServerEntityEventFinalizer> {
    let mut builder = ServerEntityEventFinalizerBuilder::new();
