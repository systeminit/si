...
struct AmiComponentFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for AmiComponentFinalizerBuilder {
    type Finalizeable = AmiComponentFinalizer;
...
pub struct AmiComponentFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl AmiComponentFinalizer {
...
impl si_cea::Finalize for AmiComponentFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_header, object) = {
            let msg: si_agent::Message<crate::protobuf::AmiComponent> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for AmiComponentFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<AmiComponentFinalizer> {
    let mut builder = AmiComponentFinalizerBuilder::new();
