...
struct ServiceEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for ServiceEntityEventFinalizerBuilder {
    type Finalizeable = ServiceEntityEventFinalizer;
...
pub struct ServiceEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl ServiceEntityEventFinalizer {
...
impl si_cea::Finalize for ServiceEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for ServiceEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<ServiceEntityEventFinalizer> {
    let mut builder = ServiceEntityEventFinalizerBuilder::new();
