...
struct ServiceEntityFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for ServiceEntityFinalizerBuilder {
    type Finalizeable = ServiceEntityFinalizer;
...
pub struct ServiceEntityFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl ServiceEntityFinalizer {
...
impl si_cea::Finalize for ServiceEntityFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
        ...
        let (_header, _qos, _response_topic, object) = {
            let msg: si_agent::Message<crate::protobuf::ServiceEntity> = message.try_into()?;
            msg.into_parts()
        };
...
impl si_cea::Finalizeable for ServiceEntityFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<ServiceEntityFinalizer> {
    let mut builder = ServiceEntityFinalizerBuilder::new();
