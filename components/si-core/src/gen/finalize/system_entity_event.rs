...
struct SystemEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for SystemEntityEventFinalizerBuilder {
    type Finalizeable = SystemEntityEventFinalizer;
...
pub struct SystemEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl SystemEntityEventFinalizer {
...
impl si_cea::Finalize for SystemEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for SystemEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<SystemEntityEventFinalizer> {
    let mut builder = SystemEntityEventFinalizerBuilder::new();
