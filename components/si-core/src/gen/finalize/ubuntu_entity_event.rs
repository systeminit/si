...
struct UbuntuEntityEventFinalizerBuilder {
    finalize_key: Option<si_cea::FinalizeKey>,
}

impl si_cea::FinalizeBuilder for UbuntuEntityEventFinalizerBuilder {
    type Finalizeable = UbuntuEntityEventFinalizer;
...
pub struct UbuntuEntityEventFinalizer {
    finalize_key: si_cea::FinalizeKey,
}

impl UbuntuEntityEventFinalizer {
...
impl si_cea::Finalize for UbuntuEntityEventFinalizer {
    async fn finalize(
        &self,
        db: &si_data::Db,
...
impl si_cea::Finalizeable for UbuntuEntityEventFinalizer {}

pub fn finalizer() -> si_cea::CeaResult<UbuntuEntityEventFinalizer> {
    let mut builder = UbuntuEntityEventFinalizerBuilder::new();
