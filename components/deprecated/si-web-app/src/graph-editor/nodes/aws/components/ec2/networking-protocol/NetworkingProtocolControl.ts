...
import VueNetworkingProtocolControl from "./VueNetworkingProtocolControl.vue";

export class NetworkingProtocolControl extends Rete.Control {
  ...
  constructor(emitter, key, readonly?: any) {
    super(key);
    this.component = VueNetworkingProtocolControl;
